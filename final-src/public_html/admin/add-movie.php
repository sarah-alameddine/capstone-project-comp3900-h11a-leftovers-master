...
if (!is_logged_in() || !$_SESSION['user']->is_admin()) {
    header('Location: /');
    exit();
}
...
if (
    ...
    } else if ($movie_id === DUPLICATE_MOVIE) {
              ...
              <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="col">
                    ...
                    <input type="text" class="form-control" id="inputTitle" placeholder="" name="title" required>  
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="col">
                    ...
                    <input type="date" class="form-control" id="inputReleaseDate" placeholder="" name="release_date" required>  
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="col">
                    ...
                    <input type="file" class="form-control" id="inputImage" placeholder="" name="image" required>  
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="col">
                    ...
                    <textarea rows="4" cols="50" type="text" class="form-control" id="inputDesc" placeholder="" name="description" required></textarea>
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="col">
                    ...
                    <?php
                        $ad2 = new AdminDashboard();
                        $genres = $ad2->get_genres();
                        foreach ($genres as $row => $val) {
                    ?>

                      <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="genre<?php echo($val['genre']); ?>" name= "genres[]" value="<?php echo($val['id']); ?>">
                        <label class="form-check-label" for="genre<?php echo($val['genre']); ?>"><?php echo($val['genre']); ?></label>
                      </div>
                ...
                <div class="form-row">
                  <div class="col">
                    <label for="inputDirector">Directors (Comma separated. Eg. John Smith,Bob Williams)</label>
                    <input type="text" class="form-control" id="inputDirector" placeholder="" name="directors" required>  
                  </div>
                </div>

                <div class="form-row">
                  <div class="col">
                    <label for="inputCast">Cast (Comma separated. Eg. John Smith,Bob Williams)</label>
                    <input type="text" class="form-control" id="inputCast" placeholder="" name="cast" required>  
                  </div>
                </div>
