                    ...
                    <div class="container" style="margin-right: 0;">
                        ...
                        <li class="nav-item dropdown">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-warning rounded-circle" data-toggle="dropdown" aria-haspopup="true" style="display: inline-flex; flex-direction: column; justify-content: center; width: 40px; height: 40px; border-radius: 50%; font-weight: bold; font-size: 30px; color: #182628;"><?php echo($_SESSION['user']->get_first_letter()); ?></button>
                        
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="/profile-page.php">Profile</a>
                                    <a class="dropdown-item" href="/../../lists/wishlist.php">Wishlist</a>
                                    <a class="dropdown-item" href="/../../lists/watch-list.php">Watch lists</a>
                                    <a class="dropdown-item" href="/../../lists/ban-list.php">Ban lists</a>
