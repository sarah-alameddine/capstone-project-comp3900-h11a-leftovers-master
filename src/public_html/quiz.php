  ...
  <body>
    ...
    <div class="container">
            ...
            <div class="col-sm">
               ...
               <div class="form-row">
                <div class="col">
                  <span style="color:#182628; font-weight:bold; font-size: 30px; margin-left: 15%">Welcome to our quizes</span> 
                </div>
              </div>
              ...
              <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="col">
                    <button type="submit" class="btn btn-primary" style="background-color: #182628;">Submit quiz</button>
                  </div>
