...
if (isset($_GET['term'])) {
    ...
    $results = $mb->search($term, $category, $sort, $user_id);
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <h1 class="searchHead"> Search result for : <i style="color:#03D8A9">"<?php echo(htmlentities($term)); ?>"<i></h1>
            </div>
            <div class="col-md-13">
                ...
                <div class="media">
                   ...
                   <div class="media-body" class="py-5" style="padding:5px;" class="d-flex align-items-center">
                        ...
                        <div style="overflow: hidden;">
                            ...
                            <!-- Add to watch list ----------> <a class="btn btn-secondary" style="float: right;" href="/profile/watch-list-add-movie.php?watchlist=<?php echo($_GET['watchlist']); ?>&movie=<?php echo($movie->get_id()); ?>" role="button"> &#10010; WATCHLIST</a>
                            <?php } ?>
                        </div>
                        <!---------- Movie description ---------->
                        <h6 id="movieDate" class="mt-0" src="<?php echo($movie->get_movie_page_path()); ?>"> <?php echo($movie->get_release_date()); ?></h6>
                        <p class="movieTitle"> 
