        ...
        <div class="row" style="border-bottom: 1px solid #182628;">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!-- only the ban list owner can view this list -->
                    <div class="col-2" style="height: 40px; left: 30%;">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm" style="height: 50px;">
                        <a href="/../../lists//create-list.php" class="btn btn-warning" role="button" style="position: absolute; top: 35%; font-weight: bold;  right: 0">Create List</a>
                    </div>
